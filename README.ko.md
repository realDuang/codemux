...
| **Codex** | JSON-RPC/stdio (app-server) | ⚠️ 실험적 |
...
> - **Codex**: `codex` CLI를 별도로 설치하고 `codex`가 PATH에 있는지 확인하세요. CodeMux는 Codex의 기존 OpenAI 로그인 또는 API 키 구성을 재사용합니다. 현재 experimental/unstable 상태입니다.
>
