// ============================================================================
// Teams Command Parser
// Parses slash commands from Teams user messages.
// Supports: /help, /status, /project, /cancel, /mode, /model, /history
//
// In Teams, @mentions appear as <at>BotName</at> in text — these are stripped
// before command parsing.
// ============================================================================

import type { ParsedCommand } from "./teams-types";
 ...
 * Shown in personal (direct) messages with the bot.
 */
 ...
 * Shown inside group chats or channels where the bot is a member.
 */
...
/** A single history entry for display as an individual message */
