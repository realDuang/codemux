...
export const zh: LocaleDict = {
  ...
  skill: {
    title: "Skills",
    description: "管理所选工作区的 CodeMux skills。项目设置只影响当前工作区；全局设置会影响所有工作区。",
    workspace: "工作区",
    workspaceDesc: "Skill 状态和项目级禁用规则会按当前选中的工作区计算。",
    defaultWorkspace: "默认",
    currentSessionWorkspace: "当前会话工作区",
    noWorkspace: "没有可用工作区",
    searchPlaceholder: "搜索 skills...",
    noSearchResults: "没有匹配的 skills",
    refresh: "刷新",
    refreshing: "刷新中...",
    empty: "当前工作区没有找到 skills",
    diagnostic: "诊断",
    openPath: "打开路径",
    scopeProject: "项目",
    scopeGlobal: "全局",
    scopeBuiltin: "内置",
    scopeProjectDesc: "存放在当前工作区的 skills。会覆盖同名全局和内置 skills。",
    scopeGlobalDesc: "所有工作区可复用的 skills，除非被项目覆盖或禁用。",
    scopeBuiltinDesc: "CodeMux 随包提供的只读内置 skills。",
    effective: "生效中",
    enableSkill: "启用",
    disableSkill: "禁用",
    enabled: "已启用",
    disabled: "已禁用",
    overridden: "被覆盖",
    disabledAt: "在 {scopes} 禁用",
    effectiveScope: "生效：{scope}",
    cardDetails: "查看详情",
    detailsTitle: "Skill 详情",
    selectedScope: "卡片 scope",
    otherScopes: "其他 scope",
    sourcePath: "源路径",
    noSkillsInScope: "此 scope 下没有 skills",
    noOtherScopes: "此 skill 没有其他 scope",
    shadowed: "被覆盖",
    notEffective: "未生效",
    noDescription: "无描述",
    enableForProject: "在此项目启用",
    disableForProject: "在此项目禁用",
    enableGlobally: "全局启用",
  ...
  harness: {
    ...
    mcp: "MCP",
    comingSoon: "即将支持",
    agentsComingSoon: "Agents 配置即将支持",
    mcpComingSoon: "MCP 配置即将支持",
  },
