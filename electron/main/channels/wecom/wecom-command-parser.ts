// ============================================================================
// WeCom Command Parser
// Parses slash commands from WeCom user messages.
// Supports: /help, /project, /cancel, /status, /mode, /model, /history
// ============================================================================

import type { ParsedCommand } from "./wecom-types";
...
/** A single history entry for display */
