...
export const zh: LocaleDict = {
  ...
  channel: {
    ...
    dingtalkBot: "钉钉机器人",
    dingtalkBotDesc: "通过钉钉机器人消息使用 AI 编码助手",
    telegramBot: "Telegram 机器人",
    telegramBotDesc: "通过 Telegram 机器人消息使用 AI 编码助手",
    wecomBot: "企业微信机器人",
    wecomBotDesc: "通过企业微信应用消息使用 AI 编码助手",
    teamsBot: "Teams 机器人",
    teamsBotDesc: "通过 Microsoft Teams 机器人消息使用 AI 编码助手",
    appId: "App ID",
