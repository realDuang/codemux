...
// Parses slash commands from Telegram user messages.
// Supports: /help, /status, /project, /cancel, /mode, /model, /history
// ============================================================================

import type { ParsedCommand } from "./telegram-types";
 ...
 *
 * Handles Telegram-style commands with optional @botname suffix:
 *   "/help"              → { command: "help", args: [] }
 *   "/help@MyBot"        → { command: "help", args: [] }
...
export function parseCommand(text: string): ParsedCommand | null {
  ...
  // Strip @botname suffix from command (e.g., "help@MyBot" → "help")
 ...
 * Shown in private (direct) messages with the bot.
 */
 ...
 * Shown inside group chats where the bot is a member.
 */
...
/** A single history entry for display as an individual Telegram message */
