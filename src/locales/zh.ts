...
export const zh: LocaleDict = {
  ...
  chat: {
    ...
    queued: "排队中",
    disconnected: "已断开",
    orchestrationRunsTitle: "编排运行",
    orchestrationRunLabel: "Team",
    orchestrationRunModeLight: "light",
    orchestrationRunModeHeavy: "heavy",
    orchestrationRunPlanning: "规划中...",
    orchestrationRunAwaitingConfirmation: "等待确认计划",
    orchestrationRunConfirmPlan: "确认并执行",
    orchestrationRunEditPlan: "编辑计划",
    orchestrationRunRunning: "{completed}/{total} 个任务",
    orchestrationRunCompleted: "已完成",
    orchestrationRunFailed: "失败",
    orchestrationRunCancelled: "已取消",
    orchestrationRunActive: "当前活跃",
    orchestrationRunCancel: "取消",
    orchestrationRunFinalResult: "最终结果",
    orchestrationSubtaskDependsOn: "依赖: {ids}",
    orchestrationSubtaskEngine: "引擎: {engine}",
    orchestrationSubtaskWorktree: "Worktree: {name}",
    orchestrationSubtaskOpenSession: "打开会话",
  },
  ...
  prompt: {
    ...
    removeImage: "移除图片",
    orchestrationRelayPlaceholder: "直接给当前 orchestrator 留言...",
    orchestrationRelayNotice: "Heavy Brain 正在运行中；你在这个 session 发送的消息会直接转发给 orchestrator。",
    orchestrationRelayImageUnsupported: "直接给 orchestrator 发消息时暂不支持图片附件。",
  ...
  notification: {
    ...
    orchestrationRunStarted: "编排已启动。",
    orchestrationRunFailed: "编排启动失败：{message}",
    orchestrationMessageRelayFailed: "转发消息给当前 orchestrator 失败：{message}",
  },
