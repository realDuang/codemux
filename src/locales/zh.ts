...
export const zh: LocaleDict = {
  ...
  remote: {
    ...
    noteUrlChangesDesc: "使用免费 Tunnel 时，每次重启会获得新的公网 URL。Webhook 渠道需要重新配置对应平台的回调地址。可配置命名 Tunnel 获得固定域名。",
    ...
    tunnelNamePlaceholder: "例如 codemux",
    tunnelHostname: "域名",
    tunnelHostnamePlaceholder: "例如 codemux.example.com",
    namedTunnelSaved: "命名 Tunnel 配置已保存",
    namedTunnelActive: "命名 Tunnel 已启用 — 域名在重启后保持不变",
    namedTunnelSetupHint: "请先运行 `cloudflared tunnel create <名称>` 和 `cloudflared tunnel route dns <名称> <域名>`。",
    noteSecurity: "访问安全",
