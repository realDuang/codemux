...
export const zh: LocaleDict = {
  ...
  chat: {
    ...
    teamRunPlanning: "规划中...",
    teamRunAwaitingConfirmation: "等待确认计划",
    teamRunConfirmPlan: "确认并执行",
    teamRunEditPlan: "编辑计划",
    teamRunRunning: "{completed}/{total} 个任务",
    teamRunCompleted: "已完成",
    teamRunFailed: "失败",
    teamRunCancelled: "已取消",
    teamRunActive: "当前活跃",
    teamRunCancel: "取消",
    teamRunFinalResult: "最终结果",
    teamTaskDependsOn: "依赖: {ids}",
    teamTaskEngine: "引擎: {engine}",
    teamTaskWorktree: "Worktree: {name}",
    teamTaskOpenSession: "打开会话",
  },
