...
// Parses slash commands from DingTalk user messages.
// Supports: /help, /status, /project, /cancel, /mode, /model, /history
// ============================================================================

import type { ParsedCommand } from "./dingtalk-types";
...
/** A single history entry for display as an individual DingTalk message */
